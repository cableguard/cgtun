...
impl Tunn {
    ...
    pub fn new(
        ...
        peer_rodtid_signature: [u8; KEY_LEN*2],
...
mod tests {
    ...
    fn create_two_tuns() -> (Tunn, Tunn) {
        ...
        tracing::debug!("Debugging: own_staticsecret_private_key: {}, own_publickey_public_key: {}, their_secret_key: {}, their_public_key: {} in fn create_two_tuns",
